...
def extract_corpus_features(wav_folder_path, alignment, save_path):
    ...
    file_list = [
        name for name in os.listdir(wav_folder_path)
        if name.endswith('.wav') and name in alignment_file_list
    ]
...
def save_normalized_data(wav_folder_path_1, wav_folder_path_2, path_alignment_file, save_path_norm_data_1, save_path_norm_data_2):
    ...
    extract_corpus_features(
        wav_folder_path_1, alignment, save_path_norm_data_1
    )
    # process the second corpus
    extract_corpus_features(
        wav_folder_path_2, alignment, save_path_norm_data_2
    )
...
def compute_distances_matrix(selected_data_corpus_1, selected_data_corpus_2, n_repr=None):
    ...
    # load the two datasets of features
